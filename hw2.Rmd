...
d_coord <- data.frame(latitude= dennys$Latitude,longitude=dennys$Longitude) %>% dataframe_tolist()
l_coord <- data.frame(latitude= lq$Latitude,longitude=lq$Longitude)  %>% dataframe_tolist()
...
spatial_dist <- function(dx,dy,lx,ly){
  ##Lei: put your spherical distance formula here
  return()
}
